...
from Product.views import (
    ...
    filter_products,
    list_brands, update_product, filter_product_by_category, search_item_in_category
)
...
urlpatterns = [ 
    ...
    #GET api/v1/products/<slug:category_slug>/search/
    path('category/<slug:slug>/search', search_item_in_category, name='filter_by_category'),
]
